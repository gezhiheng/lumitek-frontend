...
export async function brushInData(params) {
  return await axios
    .post(`${apiBaseUrl}mfd02/brush-data/`, params)
    .catch((error) => {
...
export async function skipStation(params) {
  return await axios
    .post(`${apiBaseUrl}mfd02/skip-station/`, params)
    .catch((error) => {
...
export async function cancelStation(params) {
  return await axios
    .post(`${apiBaseUrl}mfd02/cancel-station/`, params)
    .catch((error) => {
...
export async function getCancelStationCauses() {
  return await axios
    .post(`${apiBaseUrl}mfd02/cancel-validation/`)
    .catch((error) => {
...
export async function rollBackStation(params) {
  return await axios
    .post(`${apiBaseUrl}mfd02/rollback-station/`, params)
    .catch((error) => {
...
export async function unCancelStation(params) {
  return await axios
    .post(`${apiBaseUrl}mfd02/uncancel-station/`, params)
    .catch((error) => {

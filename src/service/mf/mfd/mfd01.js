...
export async function query(params) {
  return await axios.post(`${apiBaseUrl}mfd01/query/`, params).catch(error => {
    handleApiError('mfd01 query', error)
  })
}

export async function queryDepartment(params) {
  return await axios.post(`${apiBaseUrl}mfd01/department-query/`, params).catch(error => {
...
export async function getCurrentStepInfo(params) {
  return await axios.post(`${apiBaseUrl}mfd01/productseqno_monitor/`, params).catch(error => {
    handleApiError('mfd01 getCurrentStepInfo', error)
  })
}

export async function getHoldCommand(params) {
  return await axios.post(`${apiBaseUrl}mfd01/holdcode_monitor/`, params).catch(error => {
    handleApiError('mfd01 getHoldCommand', error)
  })
}

export async function getStageAndStep(params) {
  return await axios.post(`${apiBaseUrl}mfd01/holdtype_monitor/`, params).catch(error => {
...
export async function getPendingNum(params) {
  return await axios.post(`${apiBaseUrl}mfd01/pending/`, params).catch(error => {
    handleApiError('mfd01 getPendingNum', error)
  })
}

export async function getPendingInfo(params) {
  return await axios.post(`${apiBaseUrl}mfd01/pending-data-fill/`, params).catch(error => {
    handleApiError('mfd01 getPendingInfo', error)
  })
}

export async function unhold(params) {
  return await axios.post(`${apiBaseUrl}mfd01/unhold/`, params).catch(error => {

...
export async function query(params) {
  return await axios.post(`${apiBaseUrl}mfb02/query/`, params).catch(error => {
...
export async function onClickTableQuery(params) {
  return await axios.post(`${apiBaseUrl}mfb02/import-data-fill/`, params).catch(error => {
...
export async function repeal(params) {
  return await axios.post(`${apiBaseUrl}mfb02/repeal/`, params).catch(error => {

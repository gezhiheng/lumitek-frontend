<template>
  ...
  >
    ...
    <el-form-item label="扣留類型">
      <el-radio-group class="ml-4" v-model="form.holdType" :disabled="props.isUnholdPage" @change="onRadioGroupChange">
        <el-radio label="H">直接扣留</el-radio>
        <el-radio label="PH">預先扣留</el-radio>
      </el-radio-group>
    </el-form-item>
    <el-form-item label="STAGE">
      <el-select placeholder="選擇STAGE" v-model="form.stageNo" :disabled="props.isUnholdPage || disabled">
    ...
    <el-form-item label="STEP">
      <el-select placeholder="選擇STEP"  v-model="form.stepNo" :disabled="props.isUnholdPage || disabled">
    ...
    <el-form-item label="處理單位">
      <el-select  placeholder="選擇單位"  v-model="form.depNo" :disabled="props.isUnholdPage">
        <el-option />
      </el-select>
    </el-form-item>
    <el-form-item label="扣留部門">
      <el-select  placeholder="選擇部門"  v-model="form.holdDepNo" :disabled="props.isUnholdPage">
        <el-option />
      </el-select>
    </el-form-item>
    <el-form-item label="扣留代碼">
      <el-select  placeholder="選擇代碼"  v-model="form.holdCode" :disabled="props.isUnholdPage">
    ...
    <el-form-item label="放行單位">
      <el-select  placeholder="選擇單位"  v-model="form.unholdDepNo" :disabled="props.isUnholdPage">
        <el-option />
      </el-select>
    </el-form-item>
    <el-form-item label="放行時間">
      <el-input class="wider"  v-model="form.unholdOn" :disabled="props.isUnholdPage"/>
    </el-form-item>
    <el-form-item label="扣留放行command">
      <el-select class="wider" placeholder="選擇放行command" v-model="form.unholdCommand">
    ...
    <el-form-item v-if="props.isUnholdPage" class="wider" style="margin-left: 100px">
      ...
      <el-select style="margin: 0 12px 0 12px;"  v-model="data.unHoldParam"  placeholder="添加扣留command">
